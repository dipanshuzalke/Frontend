...
const testimonials = [
  {
    ...
    message: "Comarketer has revolutionized our marketing strategy—doubling our inbound leads in just two weeks!",
    image: "https://randomuser.me/api/portraits/men/75.jpg",
  },
  {
    name: "Chase Cohn",
    company: "Spaces OS: AI-first CRM for financial advisors",
    message: "With Comarketer, we’ve been able to reach our exact target persona without wasted ad spend.",
    image: "https://randomuser.me/api/portraits/men/32.jpg",
  },
  {
    name: "Prajwal",
    company: "DataTeams AI: Tech hiring and staffing agency",
    message: "Comarketer's insights have been invaluable in our recruitment funnels—our cost per hire is down 30%.",
    image: "https://randomuser.me/api/portraits/men/45.jpg",
  },
  {
    name: "Tanvi Agarwal",
    company: "Elfina Health: Mental Therapy Matching Platform",
    message: "Thanks to Comarketer, we've expanded our reach and connected with thousands of new users.",
